        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {[
                ...
                <Link
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-card border border-border hover:bg-card/80 hover:border-border/80 transition-colors cursor-pointer"
                >
          ...
          <div className="relative">
            ...
            <div className="relative bg-card rounded-3xl shadow-card-hover p-8 border border-border animate-float">
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/70">Teknisi Jaringan Level III</p>
                  </div>
                </Link>
              ...
              <div className="p-4 rounded-xl bg-muted/50 mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/70">NIK: ****-****-****-1234</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs text-foreground/70">Penerbit</div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs text-foreground/70">Diterbitkan</div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-accent border border-accent-foreground/10">
                <div>
                  <div className="text-xs text-foreground/70">KKNI Level</div>
                ...
                <Link
                  ...
                  className="w-12 h-12 rounded-xl bg-card border border-border flex items-center justify-center hover:bg-card/80 cursor-pointer transition-colors"
                >
            ...
            <Link
              ...
              className="absolute -top-4 -left-4 p-3 rounded-xl bg-card shadow-card border border-border animate-fade-in hover:bg-card/80 cursor-pointer transition-colors"
            ...
            <Link
              ...
              className="absolute -bottom-4 -right-4 p-3 rounded-xl bg-card shadow-card border border-border animate-fade-in hover:bg-card/80 cursor-pointer transition-colors"
