    ...
    for (const workshop of workshops) {
      ...
      const result = await client.query(
        `INSERT INTO workshop (
          ...
          tefa_location_name, tefa_city, tefa_province, tefa_address,
          latitude, longitude, capacity,
          geofence_radius, status
        ...
        [
          ...
          `${workshop.startDate} ${workshop.startTime || '09:00'}`,
          `${workshop.endDate} ${workshop.endTime || '17:00'}`,
          workshop.startTime || '09:00',
